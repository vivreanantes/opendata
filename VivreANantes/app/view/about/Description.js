	...
	config : {
		...
		items : [{
			html : [
					...
					"<p>Cette application est réalisée par des bénévoles. Elle est <font color='red'>en phase de développement</font>. Version 0.1309</p>",
					...
					"Les données viennent de 'Open Data Nantes' et 'Deuxième vie'.</p>",
