	...
	config : {
		...
		items : [{
			...
			items : [{
				...
				xtype : 'container',
				layout : 'vbox',
				id : "homecollectmodsdetails_recyclableetmodesdecollecte",
				items : [{
						id : "homecollectmodsdetails_recyclable",
						tpl : "Modes de collecte : "
					},
					{
						id : "homecollectmodsdetails_collectmod_1",
						xtype : "button",
						tpl : "<img src='resources/images/bac_bleu_mini.png' width='20px' /> {label}", data : { label:"Bac bleu", image : "bac_bleu_mini.png"}
					},
					{
						id : "homecollectmodsdetails_collectmod_2",
						xtype : "button",
						tpl : "<img src='resources/images/sac_jaune_mini.png' width='20px' /> {label}", data : { label:"Sac jaune", image : "sac_jaune_mini.png"}
					}]
			}],
			record : null
		}]
