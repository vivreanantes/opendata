...
Ext.define("VivreANantes.controller.ReusesController", {
	...
	onInitReusesController : function(list) {
		...
		// value :
		// /smco_reempdivers|smco_reempcartouchetoner|smco_reempelectromenag|smco_reempinfo|smco_reempjouet|smco_reemplivreCD|smco_reempmeuble|smco_reemplunettes|smco_reempvet|smco_conteneurlerelais/g
		// }]
		// });
		...
		if (store != null) {
			...
			var filterElements = Ext.create("Ext.util.Filter", {
				filterFn : function(item) {
					 ...
					 * stModesDeCollecte !== 'smco_conteneurlerelais') { return
					 * false; }
					 */
					...
					return (selectQuartier.getValue() === "all" || stQuartier === selectQuartier
							.getValue())
							&& (stTypeRegexp.test(stModesDeCollecte));
				}
			});
