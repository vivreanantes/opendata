...
Ext.define('VivreANantes.controller.AbstractController', {
	 ...
	 */
	,
	verifFerie : function(saufFerie, date) {
		var jourDebut = date.getDate();
		...
		// on ajoute le "0" pour avoir "01"
		var moisDebut = date.getMonth() + 1;
		if (moisDebut < 10) {
			moisDebut = "0" + moisDebut;
		} else {
			moisDebut = "" + moisDebut;
		}
		var currentYear = (date.getFullYear()+"").substring(2,4);
		var valid = false;
		if (saufFerie) {
			var arrayJoursFeries = new Array("010113", "010413", "010513",
					"080513", "090513", "200513", "140713", "150813", "011113",
					"111113", "251213", "010114", "210414", "010514", "080514",
					"290514", "090614", "140714", "150814", "011114", "111114",
					"251214", "010115", "060415", "010515", "080515", "140515",
					"250515", "140715", "150815", "011115", "111115", "251215",
					"010116", "060116", "270316", "280316", "010516", "050516",
					"080516", "160516", "140716", "150816", "011116", "111116",
					"251216", "010117", "060117", "160417", "170417", "010517",
					"080517", "250517", "050617", "140717", "150817", "011117",
					"111117", "251217", "010118", "010418", "020418", "010518",
					"080518", "100518", "210518", "140718", "150818", "011118",
					"111118", "251218");
			// TODO à supprimer
			var arrayJoursFeries = new Array("220513");
					
			// Si c'est un jour férié
			if (this.utilArrayContainObject(arrayJoursFeries, "" + jourDebut
							+ moisDebut + currentYear)) {
				var valid = true;
			};
		}
		return valid;
