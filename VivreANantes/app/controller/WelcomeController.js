...
Ext.define('VivreANantes.controller.WelcomeController', {
			...
			onInitWelcome2 : function(element, eOpts) {
				...
				var text = "<img src='resources/images/conteneur_verre_mini.png' width='100px' height='100px' align='right' />" +
						"<p>Réalisée par des bénévoles, cette application est <font color='blue'>en développement</font> (mars 2014).</p>" +
						...
						"<a href='http://www.mieuxtrieranantes.fr/' target=_new >mieuxtrieranantes.fr</a></p>";
