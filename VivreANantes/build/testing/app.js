...
Ext.define('VivreANantes.view.geo.MapContainer', {
			...
			config : {
				...
				// like
				// //add() or setActiveItem(). it accepts a view instance, or
				// you can give it
				// //a view config.
				// view.push({
				// title: 'Second',
 ...
 */
Ext.define('VivreANantes.view.geo.Toast', {
			extend : 'Ext.Panel',
			xtype : 'vantoast',
			config : {
				top : 0,
 ...
 * @author cpoisnel
 */
Ext.define('VivreANantes.view.game.Guess', {
			extend : 'Ext.Container',
			xtype : 'guess',
			config : {
				title : 'Apprendre',
...
Ext.define('VivreANantes.view.about.Desc' ,{
	extend : 'Ext.Container',
...
Ext.define('VivreANantes.view.calendar.Calendrier' ,{
	extend : 'Ext.Container',
...
Ext
		.define(
				'VivreANantes.controller.Geo',
				{
					...
					/**
					 * Action sur le changement de centre
					 * 
					 * @param {}
					 *            extmap
					 * @param {}
					...
					/**
					 * Action réalisée au rendu de la carte
					 * 
					 * @param {}
					 *            extmap
					 * @param {}
