			...
			<ol class="property-list adresse">
				...
				<li class="fieldcontain">
					<span id="commune-label" class="property-label"><g:message code="adresse.commune.label" default="Commune" /></span>
						...
						<span class="property-value" aria-labelledby="commune-label"><g:link controller="commune" action="show" id="${adresseInstance?.commune?.id}">${adresseInstance?.commune?.encodeAsHTML()}</g:link></span>
